...
MyGame.Game.prototype = {
    create: function () {
        ...
        this.scoreText = this.add.text(this.world.centerX, this.world.centerY + 20, '0', {
            font: "bold 238px Microsoft YaHei",
            fill: '#d4d8d3',
            align: 'center'
        });
    ...
    GameOver: function () {
        ...
        this.add.tween(this.bird).to({alpha: 0}, 1000, "Linear", true).onComplete.add(function () {
            ...
            const restartGame = () => {
                ...
                restartedGame = true;
                Wortal.analytics.logLevelEnd("Main", this.score.toString(), false);
